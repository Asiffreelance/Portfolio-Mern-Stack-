      ...
      <div className="parent py-12">
        ...
        >
          <div className="mt-6 mb-2 flex items-center justify-center flex-wrap">
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "Reactjs" && "active-btn"
                }`}
              onClick={() => {
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "WordPress" && "active-btn"
                }`}
              onClick={() => {
                setActiveBtn("WordPress");
                filterItem("WordPress");
              }}
            >
              WordPress
            </button>
            ...
            className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary duration-300 mx-3 my-3 sm:my-0 ${
              activeBtn === "Shopify" && "active-btn"
            }`}
            onClick={() => {
              setActiveBtn("Shopify");
              filterItem("Shopify");
            }}
          >
            Shopify
