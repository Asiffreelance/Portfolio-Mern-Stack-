  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <img src="https://drive.google.com/uc?export=view&id=179NDXS-t4ep09nkVli6wFVMj18pfGJjH" alt="muhammad Asif" width="113px"/>
        ...
        <div>
          <ul className="lg:flex items-center hidden">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1L0Gg2QEMUzFVd4xnutUhbopL3981a-7o/view?usp=sharing"
              target="blank"
            >
              <PrimaryBtn>
                <span>Resume</span>
